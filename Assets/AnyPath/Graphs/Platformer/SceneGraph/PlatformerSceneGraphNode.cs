...
namespace AnyPath.Graphs.PlatformerGraph.SceneGraph
{
    ...
    public class SceneGraphNodeEditor : Editor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            var fmh_105_76_638894044382265267 = Quaternion.identity; dragPosition = Handles.FreeMoveHandle(controlId, dragPosition, handleSize, Vector3.zero, Handles.CircleHandleCap);
